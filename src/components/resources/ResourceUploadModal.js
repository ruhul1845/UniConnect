...
export default function ResourceUploadModal({
  ...
  return (
    <Modal title="Upload Academic Resource" eyebrow="CR Upload" onClose={onClose}>
      <form onSubmit={onSubmit} className="space-y-5">
        <div className="grid gap-4 md:grid-cols-2">
          ...
          <Field label="Lecture No / Author">
            <input
              className={inputClass}
              value={form.lecture_no || form.author}
              onChange={(e) =>
                setForm({ ...form, lecture_no: e.target.value, author: e.target.value })
              }
            />
          </Field>
